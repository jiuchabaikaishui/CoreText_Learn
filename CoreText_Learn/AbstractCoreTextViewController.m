//
//  AbstractCoreTextViewController.m
//  CoreText_Learn
//
...
#import "AbstractCoreTextViewController.h"
#import "QSPDisplayView.h"
#import "QSPFrameParser.h"

@interface AbstractCoreTextViewController ()

@end

@implementation AbstractCoreTextViewController
...
- (void)viewDidLoad {
    ...
    config.fontSize = 16;
    config.lineSpace = 40;
    config.content = @"你好啊，真的吗？是否就很顺利的回复收到货第三方收到回复楼上的回复了不少交电话费收到回复收到货方式开会的拉动收到货撒谎的反馈是大家还非得说发货单上解放和手机端看回复你的海景房时间段和服务IE很谨慎的合法的好发生的机房环境是发货方式";//电话费呼和手机端开会方式地方我打电话副书记和覅
